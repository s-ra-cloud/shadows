...
function NodesTab({ isEditor, onSuggest }: {
  ...
  const categoryHierarchy = useMemo(() => {
    ...
    const fieldMap: Record<string, string> = { physicalCharacteristics: "physical_characteristics", object: "object", animals: "animals", domain: "domain", characterTrait: "character_trait", eventTypes: "event_types", deathTypes: "death_types" };
