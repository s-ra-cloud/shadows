    ...
    <div className="min-h-screen bg-[#0B0626] pt-24 pb-16">
      <div className="max-w-4xl mx-auto px-6">
        ...
        <section className="mb-20">
          ...
          <div className="space-y-5 text-shadows-text/60 leading-relaxed text-justify">
            <p>
              Across cultures and historical periods, mythological corpora encode structured systems of entities, attributes, and relationships that articulate cosmological frameworks, social organization, and symbolic logics. Comparative mythology has long sought to identify and analyze these recurring structures, from early philological inquiries to contemporary interdisciplinary scholarship. Yet such systems are still rarely examined through formal, large-scale comparative models capable of revealing deep structural correspondences across traditions.
            </p>
            <p>
