...
- **Five view modes:**
  ...
  - **Direct** — Ego-centric view: pick a focal deity, see only the figures sharing traits with it. Min-shared-traits slider (1–10) controls how many neighbors appear; click a neighbor to re-center on it. Line thickness = common traits count.
